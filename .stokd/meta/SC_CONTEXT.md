...
- You MUST delegate all code implementations, boilerplate writing, and editing tasks to your DeepSeek subagent using the agent-link-mcp server ('spawn_agent' tool with '"agent": "1"').

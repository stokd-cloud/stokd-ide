...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Stokd Code in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Stokd Code and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,

...
Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration).registerConfiguration({
	properties: {
		...
		// NOTE: the agent display-surface setting now registers in the terminal module
		// (`terminal.integrated.agentTabs.agentSurface`, see agentTabsContribution.ts /
		// AGENT_DEFAULT_SURFACE_SETTING_ID) so it lives alongside the agent-tabs enable flag.
	},
});
